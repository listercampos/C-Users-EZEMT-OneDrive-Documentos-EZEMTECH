...
Backend seguro para que la app y el widget investiguen en internet y respondan con IA sin exponer claves en el navegador.
...
3. En **Settings > Variables and Secrets**, agrega:
   ...
   - `ALLOWED_ORIGINS`: `https://www.ezemtech.com,https://ezemtech.com,http://localhost:4174,http://127.0.0.1:4174`
4. Publica el Worker.
5. Usa la URL del Worker en `assistantWebhookUrl`.
...
- El Worker solo acepta `POST` y limita solicitudes grandes.
